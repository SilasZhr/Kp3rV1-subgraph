...
export class Keep3rV1__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class Keep3rV1 extends ethereum.SmartContract {
  static bind(address: Address): Keep3rV1 {
    return new Keep3rV1("Keep3rV1", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): Keep3rV1__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new Keep3rV1__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<Keep3rV1__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Keep3rV1__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
